...
public class BookEJBIT {
    ...
    public void shouldCreateABook() throws Exception {
        ...
        try (EJBContainer ec = EJBContainer.createEJBContainer(properties)) {
            ...
            assertNotNull(ctx.lookup("java:global/classes/BookEJB!chapter08.BookEJBRemote"));
            assertNotNull(ctx.lookup("java:global/classes/BookEJB!chapter08.BookEJB"));

            // Looks up the EJB
            BookEJB bookEJB = (BookEJB) ctx.lookup("java:global/classes/BookEJB!chapter08.BookEJB");
